...
Public Class Inventory
    ...
    Private Sub EditBtn(sender As Object, e As RoutedEventArgs)
        ...
        ' Find the DataGridRow that contains this button
        Dim dataGridRow As DataGridRow = FindAncestor(Of DataGridRow)(button)

        ' Get the data item associated with this row
        If dataGridRow IsNot Nothing Then
            Dim member As Member = CType(dataGridRow.Item, Member)
            ' Now you can use the member object to access the row data

            Dim edit As New EditMember(member)
    ...
    Private Function FindAncestor(Of T As DependencyObject)(child As DependencyObject) As T
